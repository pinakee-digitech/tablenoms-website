...
export default function Home() {
    return (
        <div className='mainHome d-flex justify-content-center align-items-center flex-column px-2 px-sm-5'>
            ...
            <div className='d-flex justify-content-center align-items-center flex-column'>
                ...
                <div className='w-100 d-flex justify-content-around align-items-center flex-wrap flex-row'>
