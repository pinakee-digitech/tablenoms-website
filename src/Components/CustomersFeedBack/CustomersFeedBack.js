...
export default function CustomersFeedBack() {
    return (
        <div className="px-5 pb-5 d-flex justify-content-center flex-column align-items-start">
            ...
            <div className="px-5 d-flex justify-content-center flex-column flex-md-row">
                <div className="cardForComments border border-light-subtle rounded-3 border-2 p-5 m-2">
                    ...
                    <p className="fs-3 text-body-secondary pb-4">This applictaion is user-friendly for both customers and us. It reduces
                ...
                <div className="cardForComments border border-light-subtle rounded-3 border-2 p-5 m-2">
                    ...
                    <p className="fs-3 text-body-secondary pb-4">By using Tablenoms, managing the menu is as simple as doing 1st grade. By
